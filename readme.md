...
```Python
# С помощью учётки rpa1 удалось подключиться ко всем машинам, даже где не была привязана учётка.
family = "family"
user = "name_user"
...
|:---|:---|:---|:------|:---|
|0	|v01	|C:|	17.23128128|	149.9003868|
|1	|v02	|C:|	46.11068726|	149.9003868|
|2	|v03	|C:|	61.60224915|	149.9003868| 
